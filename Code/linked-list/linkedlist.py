...
class LinkedList(object):
    ...
    def length(self):
        ...
        #Best Case O(1), only one node, Worst Case O(n), traverses every node
    ...
    def get_at_index(self, index):
        ...
        #Best Case O(1), searches first node, Worst Case O(n), traverses every node and searches last
    ...
    def insert_at_index(self, index, item):
        ...
        Best case running time: ??? under what conditions? [TODO]
        Worst case running time: ??? under what conditions? [TODO]"""
        #Best Case O(1), insert at head or tail since we have pointer
        # Check if the given index is out of range and if so raise an error
        if not (0 <= index <= self.size):
            raise ValueError('List index out of range: {}'.format(index))
    ...
    def append(self, item):
        ...
        Best and worst case running time: ??? under what conditions? [TODO]"""
        #Both cases O(1), we have a pointer to the tail
    ...
    def prepend(self, item):
        ...
        Best and worst case running time: ??? under what conditions? [TODO]"""
        #O(1) for both, we have a pointer to both ends
        # Create a new node to hold the given item
        new_node = Node(item)
        # Check if this linked list is empty
        if self.is_empty():
    ...
    def replace(self, old_item, new_item):
        ...
        Best case running time: ??? under what conditions? [TODO]
        Worst case running time: ??? under what conditions? [TODO]"""
        #Best Case O(1), we replace data at the head, Worst O(n), we have to traverse every node and replace tail
    ...
    def delete(self, item):
        ...
        Best case running time: ??? under what conditions? [TODO]
        Worst case running time: ??? under what conditions? [TODO]"""
        #Best case O(1), deleting head or tail, Worst Case O(n), deleting in middle
        # Start at the head node
        node = self.head
